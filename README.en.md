...
[Download the latest release](https://github.com/Qxyz17/Estrix-Code/releases/latest)

**Estrix Code** is a zero-token-cost AI Agent desktop application.
...
When an AI reply contains a `estrix` code block in the following format, the system executes it in the sandbox and sends the result back to the AI:
...
Supported tools (called through `estrix` code blocks):
