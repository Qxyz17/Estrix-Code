...
```json
{ "mcpServers": { "filesystem": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "C:/d/SourceCode/2026/estrix-code"] } } }
```

## 当前 MCP 配置状态

用户数据目录 `%APPDATA%/estrix-ai-pro-session/` 下有：
